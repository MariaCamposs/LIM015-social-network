...
import { desktopHeader } from './header.js';
...
export const editProfile = () => {
  ...
  userDocDataInRealTime((docData) => {
    ...
    <form id="profileForm" class="profileForm">
      ...
      <section class="formProfileBox">
        <label class="profileLabel" for="petName"> Nombre de mascota
          <input class="formBox inputProfile inputs" id="petName" value="${docData.petName}"/>
        </label>
      </section>
      <section class="formProfileBox">
        <label class="profileLabel"> Presentación de Mascota
          <textarea class="formBox inputProfile textArea inputs" id="description" name="Presentación de Mascota" rows="4" maxlength="350">${docData.profileDescription}</textarea>
        </label>
      </section>
      <section class="formProfileBox">
        <label class="profileLabel"> Raza
          <input class="formBox inputProfile inputs" id="breed" value="${docData.breed}"/>
        </label>
      </section>
      <section class="formProfileBox">
        <label class="profileLabel"> Ubicación
          <input class="formBox inputProfile inputs" id="location" value="${docData.location}">
        </label>
      </section>
    ...
    section.appendChild(desktopHeader());
    section.appendChild(desktopFooter());
  ...
  userDocDataInRealTime((docData) => {
    section.innerHTML = `
      <section class="header">
        ...
        <a id="toEditProfile" href="#/home/editprofile"><img class="icon pen" src="./assets/img/pen.svg" alt="pen icon"/></i></a>
        <a><img id="close" class="icon signOut" src="./assets/img/signout.svg" alt="signout icon"/></i></a>
        <div class="circleContent"><div class="circle"><img id="circleImgProfile" src="${docData.photoURL}"></div>
        </div>
        <h1 class="petNameDesktop">${docData.petName}</h1>
        </section>
        <section class="profileDescription">
            ...
            <a href="#/home/editprofile" class="formButton">Editar Perfil</a>
        </section>
      </section>
