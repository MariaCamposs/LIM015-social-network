  ...
  getUserWithOnSnapshot(user.uid, (querySnapshot) => {
    ...
    <section class="userProfile">
      ...
      <div class="userHomeDescription">
        <h3 class="userHomeName">${dataUser.name}</h3>
        <h6 class="userHomeOthers">${(dataUser.namePet || '')} - ${(dataUser.location || '')}</h6>
      </div>
    </section>
  `;
  });
  ...
  element.innerHTML = `
    <div class="userToFollow">
      ...
      <div class="userToFollowDescription">
        <h3 class="userNameToFollow">${user.name}</h3>
        <h6 class="userOthersToFollow">${(user.namePet || '')} - ${(user.location || '')}</h6>
      </div>
    </div>
