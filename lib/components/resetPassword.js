...
export const resetPassword = () => {
  ...
  element.innerHTML = `
    <form id="passwordForm" class="resetPasswordForm">
      ...
      <a class="linkLogin" href="#/signup" id="signUp" class="formText formText-bold">Crear cuenta nueva</a>
      <a class="linkLogin" href="#/login" id="signIn" class="formText formText-bold">Volver a inicio de sesión</a>
    </form>
  `;
