  ...
  header.innerHTML = `
    <section class="headerBox">
      ...
      <nav class="navDesktop">
        ...
        <a href="#/home/createpost"><img class="icon-header" src="./assets/img/addpost.svg" alt="add post icon"/></a>
        <a href="#/home/profile"><img class="icon-header" src="./assets/img/profile.svg" alt="profile icon"/></a>
