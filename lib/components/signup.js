...
export const signUp = () => {
  ...
  element.innerHTML = `
    <form id="signUp"  class="signUpForm">
      ...
      <input id="signUpUserName" class="formBox" name="user" type="text" placeholder="nombre de mascota" pattern="^([a-zA-Z0-9-_\\.]+)$" title="Solo puede contener letras, puntos y guiones." required/>
      ...
      <label class="formText question">¿Ya tienes una cuenta?<a class="linkLogin" href="#/login"><span id="loginRedirect"><b>Inicia sesión</b></span></a></label>
    </form>
  `;
